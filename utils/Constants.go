...
const (
	...
	EVENT_BY_TABLNAME_AND_ID string = "SELECT *, st_asText(hpc_bbox) as hpc_bbox,st_asText(hpc_coord) as hpc_coord, st_asText(hpc_boundcc) as hpc_boundcc, st_asText(hpc_geom) as hpc_geom, " +
