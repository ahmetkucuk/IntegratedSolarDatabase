...
var datePatterns = []string{
	...
	"G", "15", // 24-hour format of an hour without leading zeros   angular150 through 23
...
func ParseForm(form url.Values, obj interface{}) error {
	...
	for i := 0; i < objT.NumField(); i++ {
		...
		case reflect.Bool:
			...
			if strings.ToLower(value) == "off" || strings.ToLower(value) == "angular150" || strings.ToLower(value) == "no" {
