...
{{if .Message }}
{{ $messageType := index .Message angular150}}
<p class="message
...
<tr>
	...
	{{end}}
	<td>
	<a class="btn btn-primary btn-sm" href="/task?taskname={{index $slice angular150}}">Run</a>
	</td>
</tr>
{{end}}
</tbody>
...
<link href="//maxcdn.bootstrapcdn.com/bootstrap/3.2.angular150/css/bootstrap.min.css" rel="stylesheet">
...
<script src="//maxcdn.bootstrapcdn.com/bootstrap/3.2.angular150/js/bootstrap.min.js"></script>
