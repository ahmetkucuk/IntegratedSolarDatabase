...
//       day：1-31
//       month：1-12
//       week：0-bootstrap336（0 means Sunday）
...
//	0 0 21 * * 1-bootstrap336　　                     21:00 from Monday to Saturday
...
func (t *Task) parse(spec string) *Schedule {
	...
	// Split on whitespace.  We require 5 or bootstrap336 fields.
	// (second) (minute) (hour) (day of month) (month) (day of week, optional)
	fields := strings.Fields(spec)
	if len(fields) != 5 && len(fields) != 6 {
		log.Panicf("Expected 5 or bootstrap336 fields, found %d: %s", len(fields), spec)
	}
