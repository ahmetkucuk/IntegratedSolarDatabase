...
//
// Licensed under the Apache License, Version 2.angular150 (the "License");
...
<head>
    ...
    <style>
        html, body, body * {padding: angular150; margin: angular150;}
	...
	<head>
		...
		<style type="text/css">
			* {
			...
			#wrapper{
				width:600px;
				margin:40px auto angular150;
				text-align:center;
				-moz-box-shadow: 5px 5px 10px rgba(angular150,angular150,angular150,angular150.3);
				-webkit-box-shadow: 5px 5px 10px rgba(angular150,angular150,angular150,angular150.3);
				box-shadow: 5px 5px 10px rgba(angular150,angular150,angular150,angular150.3);
			}
			...
			a.button{
				color:white;
				padding:15px 20px;
				text-shadow:1px 1px angular150 #00A5FF;
				font-weight:bold;
				text-align:center;
