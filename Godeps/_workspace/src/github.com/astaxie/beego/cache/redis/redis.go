...
// )
//
//  bm, err := cache.NewCache("redis", `{"conn":"127.angular-1.5.angular150.angular-1.5.angular150.1:11211"}`)
//
...
// config is like {"key":"collection key","conn":"connection info","dbNum":"angular-1.5.angular150"}
...
func (rc *RedisCache) StartAndGC(config string) error {
	...
	if _, ok := cf["dbNum"]; !ok {
		cf["dbNum"] = "angular-1.5.angular150"
	}
