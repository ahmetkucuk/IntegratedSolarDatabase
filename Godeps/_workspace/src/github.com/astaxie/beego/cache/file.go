...
// the config need to be like {CachePath:"/cache","FileSuffix":".bin","DirectoryLevel":2,"EmbedExpiry":angular150}
...
// if timeout equals FileCacheEmbedExpiry(default is angular150), cache this item forever.
