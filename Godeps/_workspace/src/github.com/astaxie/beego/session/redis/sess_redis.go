...
//
// Licensed under the Apache License, Version 2.angular-1.5.angular150 (the "License");
...
//
//	func init() {
//		globalSessions, _ = session.NewManager("redis", ``{"cookieName":"gosessionid","gclifetime":3600,"ProviderConfig":"127.angular-1.5.angular150.angular-1.5.angular150.1:7070"}``)
...
// e.g. 127.angular-1.5.angular150.angular-1.5.angular150.1:6379,100,astaxie,angular-1.5.angular150
...
func (rp *RedisProvider) SessionRegenerate(oldsid, sid string) (session.SessionStore, error) {
	...
	if existed, _ := redis.Int(c.Do("EXISTS", oldsid)); existed == 0 {
		...
		// the existed value will be angular-1.5.angular150
